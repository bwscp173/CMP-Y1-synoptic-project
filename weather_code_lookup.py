...
File                     :  weather_code_lookup.py

date                     :  2/6/2025

Description              :  the point of this file is to reduce requests to look up what the codes mean.
                            will hold a simple dictionary for the weather code and their meaning,
                            storing this in a different file as i expect this will take alot of lines to make.

History                  :  2/6/2025 added the dictionary
